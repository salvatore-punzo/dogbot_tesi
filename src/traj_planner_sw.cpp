...
{   
     ...
     by<<0, 0, initacc(1,0), -0.02, endvel(1,0),endacc(1,0);
     ...
     bz<<0.0279, 0.02, initacc(2,0), 0.0379, 0.0,endacc(2,0);
     ...
     by<<-0.02, initvel(1,0), initacc(1,0), -0.04, -0.0022,endacc(1,0);
     ...
     bz<<0.0379, 0, initacc(2,0), 0.0259, -0.02,endacc(2,0);
     ...
     for(int i=size_half+1; i<size+1; i++)
     {   double tn=0.001*i;
